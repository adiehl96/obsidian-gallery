...
const EXTENSIONS = ['png', 'jpg', 'jpeg', "webp", "gif", "webm", 'mp4'];
...
const addEmbededTags = async (imgTFile, infoTFile, plugin) => {
    ...
    if (shouldColor) {
        ...
        colors = await extractColors_browser_umdExports.extractColors(measureEl, EXTRACT_COLORS_OPTIONS);
    }
...
_SuggestionDropdown_self = new WeakMap(), _SuggestionDropdown_suggestions = new WeakMap(), _SuggestionDropdown_showing = new WeakMap(), _SuggestionDropdown_selected = new WeakMap(), _SuggestionDropdown_input = new WeakMap(), _SuggestionDropdown_leftLocked = new WeakMap(), _SuggestionDropdown_instances = new WeakSet(), _SuggestionDropdown_onKeyDown = function _SuggestionDropdown_onKeyDown(event) {
    ...
    for (let i = 0; i < items.length; i++) {
        ...
        const result = obsidian.fuzzySearch({ fuzzy: input.split(""), query: input, tokens: input.split(" ") }, items[i]);
        if (result) {
...
var _ImageMenu_instances, _ImageMenu_plugin, _ImageMenu_mediaSearch, _ImageMenu_mediaGrid, _ImageMenu_infoView, _ImageMenu_targets, _ImageMenu_isRemote, _ImageMenu_createItem, _ImageMenu_submit, _ImageMenu_results, _ImageMenu_resultOpenImage, _ImageMenu_resultOpenMeta, _ImageMenu_resultOpenInfoLeaf, _ImageMenu_resultShareMedia, _ImageMenu_resultCopyImage, _ImageMenu_canConvertToPng, _ImageMenu_isVideoSupported, _ImageMenu_convertToPng, _ImageMenu_resultCopyImageLink, _ImageMenu_resultCopyMetaLink, _ImageMenu_resultAddTag, _ImageMenu_resultPullTags, _ImageMenu_resultRemoveTag, _ImageMenu_resultMoveImages, _ImageMenu_resultRenameImage, _ImageMenu_resultDeleteMeta, _ImageMenu_resultDeleteImage, _ImageMenu_refreshImageGrid, _ImageMenu_getPath, _ImageMenu_getSource;
var Options;
(function (Options) {
...
class MediaGrid {
    ...
    async itemClick(evt) {
        ...
        if (obsidian.Keymap.isModifier(evt, 'Shift') || this.selectMode) {
...
/* node_modules/svelte-grid/src/MoveResize/index.svelte generated by Svelte v4.2.5 */
...
/* node_modules/svelte-grid/src/index.svelte generated by Svelte v4.2.5 */
...
/* src/svelte/Gallery.svelte generated by Svelte v4.2.5 */
    ...
    async galleryImageInfo(source, el, sourcePath, plugin) {
        ...
        if (args.imgPath.match(VIDEO_REGEX)) {
            ...
            if (obsidian.Platform.isDesktopApp && imgTFile) {
                let colors = await extractColors_browser_umdExports.extractColors(measureEl, EXTRACT_COLORS_OPTIONS);
                for (let i = 0; i < colors.length; i++) {
                    hexList.push(colors[i].hex);
                }
            }
...
class GalleryTagsPlugin extends obsidian.Plugin {
    ...
    buildTagCache() {
        ...
        new obsidian.Notice(this.propertyCache['artist'].length.toString());
    }
